...
import { Download, FileText, RefreshCw, TrendingUp, Users, ShoppingCart, DollarSign, CreditCard } from 'lucide-react';
          ...
          <>
            <section className="statistics">
              ...
              <div className="stat-card">
                <h3>Orders</h3>
                <p>{orders.filter(order => order.Order_Status !== "Delivered").length || 0}</p>
